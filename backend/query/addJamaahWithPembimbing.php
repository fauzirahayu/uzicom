...
if (isset($_POST['simpan'])) {
    ...
    if ($no_porsi != '' && $no_porsi != '-') {
        ...
        if ($totalNoPorsi > 0) {
            echo '<script>alert("No Porsi sudah terdaftar di seluruh tahun. Silakan gunakan No Porsi yang berbeda."); window.location.href = "../../contern/jamaahHaji/index.php";</script>';
            $conn->close();
            exit();
        }
    }
