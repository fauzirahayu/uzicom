...
if (isset($_POST['update'])) {
    ...
    if ($status === 'lunas') {
        ...
        if ($totalNoPorsi > 0) {
            echo '<script>alert("No Porsi sudah terdaftar di tahun lain. Silakan gunakan No Porsi yang berbeda."); window.location.href = "../../contern/jamaahHaji/editJamaah2029.php?id=' . $id . '";</script>';
            $conn->close();
            exit();
        }
    }
