...
if (isset($_POST['update'])) {
    ...
    if ($totalNIK > 0) {
        echo '<script>alert("NIK sudah terdaftar di tahun lain. Silakan gunakan NIK yang berbeda."); window.location.href = "../../contern/jamaahHaji/editJamaah2029.php?id=' . $id . '";</script>';
        $conn->close();
        exit();
    }
