...
if (isset($_POST['simpan'])) {
    ...
    $cekJumlah = $conn->prepare("SELECT COUNT(*) FROM jamaah_2028 WHERE id_pembimbing = ?");
    ...
    if ($totalNIK > 0) {
        echo '<script>alert("NIK sudah terdaftar di tahun lain. Silakan gunakan NIK yang berbeda."); window.location.href = "../../contern/jamaahHaji/tambahJamaah2028.php";</script>';
        $conn->close();
        exit();
    }
