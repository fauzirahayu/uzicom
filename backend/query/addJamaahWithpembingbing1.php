...
if (isset($_POST['simpan'])) {
    ...
    if ($no_porsi != '' && $no_porsi != '-') {
        ...
        if ($totalNoPorsi > 0) {
            echo '<script>alert("No Porsi sudah terdaftar di seluruh tahun. Silakan gunakan No Porsi yang berbeda."); window.location.href = "../../contern/jamaahHaji/tambahJamaah2027.php";</script>';
            $conn->close();
            exit();
        }
    }
