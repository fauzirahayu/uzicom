...
<head>
    ...
    <title>Data Jamaah Haji 2026</title>
...
<body>
    <div class="header"><i class="bi bi-building"></i>Data Jamaah Haji 2026</div>
    <div class="container">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card card-jamaah">
                        <div class="card-body text-start">
                            ...
                            <div class="card-text"><strong>No Porsi:</strong> <?php echo htmlspecialchars(substr($data['no_porsi'] ?? '', 0, 1) . str_repeat('*', strlen($data['no_porsi'] ?? '') - 2) . substr($data['no_porsi'] ?? '', -1)); ?></div>
                            ...
                            <div class="card-text"><strong>Telepon:</strong> <a href="whatsapp://send?phone=<?php echo preg_replace('/[^0-9]/', '', $data['telepon'] ?? ''); ?>&text=Halo%20Jamaah%20Haji%2C%20ini%20dari%20tim%20kami.%20Mohon%20konfirmasi%20kehadiran%20Anda%20dalam%20waktu%2024%20jam%20atau%20data%20akan%20dihapus%20dari%20sistem." title="Hubungi via WhatsApp"><?php echo htmlspecialchars($data['telepon'] ?? ''); ?> <i class="bi bi-whatsapp text-success"></i></a></div>
...
<?php include '../contern/partials/footer.php'; ?>
