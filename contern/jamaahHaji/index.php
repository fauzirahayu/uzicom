...
<head>
    ...
    <title>Tambah Jamaah Haji</title>
...
<body>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="card card-form" id="formCard">
                    <h3 class="form-title"><i class="bi bi-person-plus-fill"></i> Tambah Data Jamaah Haji</h3>
                    <form action="../../backend/query/addJamaahWithPembimbing.php" method="POST" enctype="multipart/form-data">
                        <div class="row g-4">
                            <div class="col-md-6">
    ...
    <script>
        ...
        // Animasi slide dari bawah ke atas saat halaman dimuat
