...
<head>
    ...
    <title>Tambah Jamaah Haji 2029</title>
...
<body>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="card card-form" id="formCard">
                    <h3 class="form-title"><i class="bi bi-person-plus-fill"></i> Tambah Data Jamaah Haji 2029</h3>
                    <form action="../../backend/query/addJamaahWithPembimbing4.php" method="POST" enctype="multipart/form-data">
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="id_pembimbing" name="id_pembimbing">
                                    ...
                                    $sqlPembimbing = "SELECT p.id, p.nama_lengkap FROM pembimbing_haji p LEFT JOIN jamaah_2029 j ON p.id = j.id_pembimbing GROUP BY p.id HAVING COUNT(j.id_pembimbing) < 20";
    ...
    <script>
        ...
        document.getElementById('bulan').addEventListener('change', function() {
            ...
            if (bulan) {
                const daysInMonth = new Date(2029, bulan, 0).getDate();
        ...
        document.getElementById('tanggal').addEventListener('change', function() {
            ...
            if (bulan && tanggal) {
                jadwalBerangkat.value = `2029-${bulan}-${tanggal}`;
            }
        });
