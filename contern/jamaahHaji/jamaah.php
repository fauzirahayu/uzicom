...
<body>
    ...
    <div class="container">
        ...
        <a href="index.php" class="floating-add-btn" title="Tambah Data Jamaah">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card card-jamaah">
                        <div class="card-body text-start">
                            ...
                            <div class="card-text"><strong>Telepon:</strong> <a href="javascript:void(0)" onclick="sendWhatsAppWithPDF('<?php echo preg_replace('/[^0-9]/', '', $data['telepon']); ?>', '<?php echo addslashes($data['nama_lengkap']); ?>', '<?php echo $data['id']; ?>', '2026')" title="Kirim PDF via WhatsApp"><?php echo $data['telepon']; ?> <i class="bi bi-whatsapp text-success"></i></a></div>
                        ...
                        <div class="card-footer">
                            <a href='editJamaah.php?id=<?php echo $data['id']; ?>' class="edit-btn"><i class="bi bi-pencil"></i></a>
                            <a href='../../backend/query/hapus.php?id=<?php echo $data['id']; ?>' class="hapus-btn"
