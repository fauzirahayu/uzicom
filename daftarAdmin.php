  ...
  <div class="container-fluid login-container">
    <div class="row h-100">
      ...
      <div class="col-md-6 login-left">
        <h2 class="text-center mb-4">DAFTAR ADMIN BARU</h2>
        <p class="text-center text-muted">Silakan isi detail Anda untuk mendaftar sebagai admin.</p>

        <form action="backend/query/proses_daftar_admin.php" method="POST" id="registerForm">
          <div class="mb-3">
